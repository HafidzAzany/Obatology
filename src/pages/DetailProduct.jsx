      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div>
            ...
            <div className="mb-6">
              <h2 className="text-2xl font-semibold text-gray-800 mb-2">Rp99.990</h2>
              <p className="text-green-600 font-medium">Stok tersedia: {product.stock}</p>
            </div>

            <div className="mb-6">
              <h3 className="text-lg font-semibold mb-2">Deskripsi Produk</h3>
              <p className="text-gray-600">
                {product.name} adalah obat berkualitas tinggi yang digunakan untuk mengatasi berbagai kondisi kesehatan. 
                Produk ini telah terdaftar dengan ID {product.id} dan termasuk dalam kategori {product.group}.
              </p>
            </div>
            ...
            <div className="mb-6">
              ...
              <ul className="text-gray-600 space-y-2">
                <li><strong>ID Produk:</strong> {product.id}</li>
                <li><strong>Kategori:</strong> {product.group}</li>
                <li><strong>Stok Tersedia:</strong> {product.stock}</li>
              </ul>
            </div>
